...
if clear_button_clicked:
    st.session_state.translation_history.clear()  # Clear translation history
    st.session_state.file_history.clear()  # Clear file history
    st.session_state.user_input = ""  # Clear user input text
